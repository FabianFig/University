...
- Programming-Assignment-3: Nickle ILOC compiler workspace with the shared Nickle runtime snapshot in `nickle/` and sample `.c` / `.iloc` inputs.
- Programming-Assignment3: Companion Nickle ILOC samples for the shared runtime and compiler exercises.
...
- Nickle-related work uses the repository snapshot under `Programming-Assignment-3/nickle/`.
